...
export async function ScrollCue() {
  ...
  return (
    <a
      href="#about"
      aria-label={t("label")}
      className="hp-cue-bounce hidden md:block absolute bottom-8 left-1/2 -translate-x-1/2 text-gruvbox-yellow hover:text-gruvbox-yellow-aa dark:hover:text-[#fe8019] transition-colors"
    >
      <svg
        width={64}
        height={99}
